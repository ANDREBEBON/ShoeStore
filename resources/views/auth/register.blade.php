    ...
    <div class="container main">
        <div class="row">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="input-field">
                        <input type="password" class="input @error('password') is-invalid @enderror" id="password" name="password" required="" autocomplete="new-password">
                ...
                <div class="input-field">
                        <input type="password" class="input" id="password-confirm" name="password_confirmation" required="" autocomplete="new-password">
